...
<img src="https://raw.githubusercontent.com/Sphere-AI-Lab/orbit/main/docs/assets/images/brand/orbit_logo.png" alt="Orbit Logo" width="340">

### **Enterprise-Grade Reinforcement Learning for Large-Scale Model Post-Training**

[![Website](https://img.shields.io/badge/website-spherelab.ai%2Forbit-d55816)](https://spherelab.ai/orbit)
[![GitHub Repo](https://img.shields.io/badge/github-radixark%2Fmiles-black?logo=github)](https://github.com/Sphere-AI-Lab/orbit)
[![Docs](https://img.shields.io/badge/docs-spherelab.ai%2Forbit-d55816)](https://spherelab.ai/orbit)
[![License](https://img.shields.io/github/license/Sphere-AI-Lab/orbit)](LICENSE)
[![Slack](https://img.shields.io/badge/slack-%23orbit--rl-brightgreen.svg)](https://slack.sglang.ai)

| [**Website**](https://spherelab.ai/orbit) | [**Documentation**](https://spherelab.ai/orbit) | [**Quick Start**](https://spherelab.ai/orbit/getting-started/quick-start) | [**Supported Models**](https://spherelab.ai/orbit/models) | [**Orbit Diffusion**](https://github.com/radixark/miles_diffusion) | [**Blog**](https://www.lmsys.org/blog?filter=orbit) | [**Slack**](https://slack.sglang.ai) (`#orbit-rl`) |
...
[Training Backends](https://spherelab.ai/orbit/user-guide/training-backend).
...
- **Fully async RL.** Rollout and training workers are decoupled, with configurable on- and
  ...
  and eval modes. See [Fully Async RL](https://spherelab.ai/orbit/user-guide/fully-async).
...
- **Fast weight updates.** New weights reach the engines in-loop in seconds, even on a
  ...
  [P2P RDMA](https://spherelab.ai/orbit/advanced/p2p-weight-transfer) as the fast path
  for disaggregated setups.
- **Low-precision training.** [MXFP8 and NVFP4](https://spherelab.ai/orbit/advanced/low-precision)
  training with a numerically stable RL recipe that reduces precision-induced divergence.
  FP8, [INT4 QAT](https://spherelab.ai/orbit/advanced/int4-qat), BF16 and FP16 are also
  supported.
- **LoRA and multi-LoRA.** [Low-rank adapters](https://spherelab.ai/orbit/advanced/lora)
...
- **Token-in-token-out (TITO).** Supported for
  [every model and every black-box harness](https://spherelab.ai/orbit/user-guide/agentic-rollout),
...
- **Rollout Routing Replay (R3).** Expert routing recorded during rollout is
  [replayed in the trainer's forward pass](https://spherelab.ai/orbit/advanced/orbit-router),
...
- **Fault tolerance.** When an SGLang engine dies, Orbit
  [recovers it and resumes the run in place](https://spherelab.ai/orbit/advanced/fault-tolerance):
  no restart, no pause.
...
- **Day-0 model support.** DeepSeek-V4, Kimi-K3, GLM-5.2, Inkling and Nemotron landed on
  ...
  and Qwen3.5. See [Models](https://spherelab.ai/orbit/models).
- **Extensive hardware support.** NVIDIA GB300, GB200, B300, B200, H200, H100 and A100, and
  ...
  [Installation](https://spherelab.ai/orbit/getting-started/installation#hardware-requirements)
  for per-GPU status and the container image for each.
- **Wide recipe support.** GRPO, GSPO, PPO and REINFORCE++ for RL, plus SFT and
  [on-policy distillation](https://spherelab.ai/orbit/advanced/on-policy-distillation).
- **Agentic environments.** Train coding and computer-use agents through connectors for
  ...
  [Agentic Environments](https://spherelab.ai/orbit/user-guide/environments).
...
- [Install Orbit](https://spherelab.ai/orbit/getting-started/installation)
- [Quick Start](https://spherelab.ai/orbit/getting-started/quick-start)
- [Supported Models](https://spherelab.ai/orbit/models)
- [Core Concepts](https://spherelab.ai/orbit/user-guide/concepts)
- [Launch Script Walkthrough](https://spherelab.ai/orbit/user-guide/launch-script)
- [Training Backends](https://spherelab.ai/orbit/user-guide/training-backend)
- [Contribution Guide](https://spherelab.ai/orbit/developer/contributor-guide)
...
<img src="https://raw.githubusercontent.com/Sphere-AI-Lab/orbit/main/docs/assets/images/acknowledgment.png" alt="Organizations building on, contributing to, and collaborating with Orbit" width="900">

</div>

## Citation

If Orbit is useful in your research or your product, please cite it:

```bibtex
@misc{orbit2026,
  title        = {Orbit: Enterprise-Grade Reinforcement Learning for Large-Scale Model Post-Training},
  author       = {Orbit Team},
  year         = {2026},
  howpublished = {\url{https://github.com/Sphere-AI-Lab/orbit}}
}
```
