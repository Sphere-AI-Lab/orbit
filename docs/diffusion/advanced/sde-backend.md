...
- [Customization](/diffusion/user-guide/customization) — `--diffusion-step-strategy-path` and `--sde-step-backend-path`.
- [SD3 model guide](/diffusion/models/sd3/sd3) — Flow-GRPO vs NFT recipe flags.
