...
H3 is not on `main` of either repo. Finish [Installation](/diffusion/getting-started/installation) first
...
Paths below match the Docker image (`/root/orbit_diffusion`, `/sgl-workspace/sglang`).
...
**Status:** [📈 V — Verified](/diffusion/user-guide/recipe-verification#v), based on the complete run reported on PR #154.
...
![MiniMax H3 log_prob_mean_abs_diff](/diffusion/assets/images/h3/log_prob_diff.png)

![MiniMax H3 eval PickScore](/diffusion/assets/images/h3/reward_eval.png)

![MiniMax H3 train rollout PickScore](/diffusion/assets/images/h3/reward_rollout.png)
