...
Orbit integrates NeMo Gym as an
...
so Orbit' session server records every turn losslessly (token ids, logprobs,
...
[`examples/experimental/nemo-gym`](https://github.com/Sphere-AI-Lab/orbit/tree/main/examples/experimental/nemo-gym).
In short:
...
2. **Data** — convert SWE-bench Verified to Orbit prompt data with
...
[recipe README](https://github.com/Sphere-AI-Lab/orbit/blob/main/examples/experimental/nemo-gym/README.md)
