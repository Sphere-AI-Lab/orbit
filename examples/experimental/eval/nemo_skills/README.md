...
```bash
bash examples/experimental/eval/scripts/run-qwen3-4B.sh
```

## Configuration

The evaluation configuration is defined in `examples/experimental/eval/scripts/multi_tasks.yaml`. It specifies:
