...
```bash
python examples/experimental/formal_math/single_round/prepare_data.py --output-name minimal_demo
```
...
```bash
python examples/experimental/formal_math/single_round/run_minimal.py
```
