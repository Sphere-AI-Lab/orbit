...
CUSTOM_ARGS=(
   --custom-generate-function-path examples.experimental.strands_sglang.generate_with_strands.generate
   --custom-rm-path examples.experimental.strands_sglang.generate_with_strands.reward_func
)
