...
# Smoke config for miles.orbit.rewards.genrm_judge: --group-rm hands the whole
...
# NOTE: eval is off — GenRM rewards are relative within a group; singleton
# eval groups are a constant 0.5 (use llm_judge score mode for judge eval).
set -euo pipefail
...
# === Recipe identity ===
LAUNCHER_NAME=smoke_qwen25_05b_genrm
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-0.5B-Instruct_genrm_smoke"
