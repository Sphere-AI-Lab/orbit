...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen25_05b_bf16_math_megatron_lora_ppo_adapter_critic_smoke
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-0.5B-Instruct_math_lora_ppo_adapter_critic_smoke"
