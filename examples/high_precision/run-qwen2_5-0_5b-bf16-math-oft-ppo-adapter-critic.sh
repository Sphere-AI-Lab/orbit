...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen25_05b_bf16_math_megatron_oft_ppo_adapter_critic
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-0.5B-Instruct_math_oft_ppo_adapter_critic"
