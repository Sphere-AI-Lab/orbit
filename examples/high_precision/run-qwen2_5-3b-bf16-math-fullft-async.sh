#!/usr/bin/env bash
# Qwen2.5-3B-Instruct BF16 FULL fine-tuning on the math dataset — async training mode.
# Mechanical copy of run-qwen2_5-3b-bf16-math-oft.sh with the PEFT flags removed: no
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen25_3b_bf16_math_megatron_fullft_async
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-3B-Instruct_math_fullft_async"
