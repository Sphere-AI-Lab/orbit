#!/usr/bin/env bash
# Qwen2.5-3B-Instruct BF16 + OFT on the math dataset. Self-contained launcher.
set -euo pipefail
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen25_3b_bf16_math_megatron_oft
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-3B-Instruct_math_oft"
