#!/usr/bin/env bash
# Qwen2.5-7B BF16 + LoRA r8/a16 on PEFT-Arena openr1-50k. B200 variant of
# run-qwen2_5-7b-bf16-openr1-lora.sh.
#
# Recipe (LoRA rank/alpha, lr, batch sizes, num-rollout, n-samples, context
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen25_7b_openr1_lora_r8_a16_bs32_r1000_lr1e5_b200
...
# requests budget. mem-fraction-static raised to 0.85 since LoRA training
