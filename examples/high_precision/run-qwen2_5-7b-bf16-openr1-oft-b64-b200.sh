#!/usr/bin/env bash
# Qwen2.5-7B BF16 + OFT (block-size 64) on PEFT-Arena openr1-50k. B200 variant
# of run-qwen2_5-7b-bf16-openr1-oft-b64.sh.
#
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen25_7b_openr1_oft_b64_bs32_r1000_lr1e5_b200
