#!/usr/bin/env bash
# Qwen3-30B-A3B-Instruct-2507 (MoE) BF16 + LoRA on PEFT-Arena openr1-50k, tuned for 8xB200.
# TP=1 EP=8, flashinfer MHA, LoRA rank 32, lr=1e-5, rotary base 1e7, eval disabled.
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen3_30b_a3b_instruct2507_bf16_peft_arena_openr1_lora_orbit_b200_tp1_ep8_bs16_steps500
