#!/usr/bin/env bash
# Qwen3-4B-Instruct-2507 BF16 + OFT on the math dataset, fully async rollout mode.
# Actor and rollout GPUs are disjoint. Uses train_async.py with fully-async rollout.
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen3_4b_bf16_math_megatron_oft_fully_async
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen3-4B-Instruct-2507-BF16_math_oft_fully_async"
...
ROLLOUT_ARGS=(
    ...
    --rollout-function-path orbit.peft.rollout.fully_async_rollout.generate_rollout_fully_async
)
