#!/usr/bin/env bash
# Qwen3-4B-Instruct-2507 BF16 + OFT on the math dataset. Self-contained launcher.
set -euo pipefail
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen3_4b_bf16_math_megatron_oft
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen3-4B-Instruct-2507-BF16_math_oft"
