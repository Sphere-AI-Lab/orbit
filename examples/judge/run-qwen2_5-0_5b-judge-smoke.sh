...
# Smoke config for orbit.peft.rewards.llm_judge: an external judge model grades each
...
# === Recipe identity ===
LAUNCHER_NAME=smoke_qwen25_05b_judge
...
JUDGE_MODE="${JUDGE_MODE:-equivalence}"
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-0.5B-Instruct_judge_smoke"
