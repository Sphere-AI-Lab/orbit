#!/usr/bin/env bash
# Qwen3-30B-A3B (MoE) FP8 + OFT on the math dataset. Self-contained launcher.
# Equivalent to the Instruct-2507 checkpoint variant; retained as a stable
# entrypoint for scripts and cron jobs that reference this name directly.
...
if is_true "${SGLANG_OFT_PARITY_MODE:-0}"; then
