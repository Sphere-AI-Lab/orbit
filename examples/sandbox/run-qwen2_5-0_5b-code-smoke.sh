...
# Smoke config for miles.orbit.rewards.sandbox.code_rm: the rollout's extracted
...
# threat model in miles/orbit/rewards/sandbox/__init__.py.
set -euo pipefail
...
# === Recipe identity ===
LAUNCHER_NAME=smoke_qwen25_05b_code
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen2.5-0.5B-Instruct_code_smoke"
...
ROLLOUT_ARGS=(
    ...
    --custom-rm-path miles.orbit.rewards.sandbox.code_rm.reward_func
