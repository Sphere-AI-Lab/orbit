#!/usr/bin/env bash
# Llama-3.1-8B OFT SFT on tau/commonsense_qa converted with tools/convert_sft_dataset_to_orbit.py.
set -euo pipefail
...
SFT_DATASET_NAME="commonsenseqa"
SFT_TRAIN_JSONL_DEFAULT="${SFT_DATA_ROOT}/commonsenseqa/train.jsonl"
SFT_SAVE_DIR_SUFFIX="commonsenseqa"
