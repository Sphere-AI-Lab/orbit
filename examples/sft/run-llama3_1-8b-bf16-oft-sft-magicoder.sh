#!/usr/bin/env bash
# Llama-3.1-8B OFT SFT on ise-uiuc/Magicoder-OSS-Instruct-75K converted with tools/convert_sft_dataset_to_orbit.py.
set -euo pipefail
...
SFT_DATASET_NAME="magicoder"
SFT_TRAIN_JSONL_DEFAULT="${SFT_DATA_ROOT}/magicoder/train.jsonl"
SFT_SAVE_DIR_SUFFIX="magicoder"
