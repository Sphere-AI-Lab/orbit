#!/usr/bin/env bash
# Llama-3.1-8B OFT SFT on AI-MO/NuminaMath-CoT converted with tools/convert_sft_dataset_to_orbit.py.
set -euo pipefail
...
SFT_DATASET_NAME="numinamath"
SFT_TRAIN_JSONL_DEFAULT="${SFT_DATA_ROOT}/numinamath/train.jsonl"
SFT_SAVE_DIR_SUFFIX="numinamath"
