...
# (orbit.rollout.swe_agent.episode.generate); SWE-bench verification of the
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/SWE_agent_smoke"
...
ROLLOUT_ARGS=(
    ...
    --custom-generate-function-path "${CUSTOM_GENERATE_PATH:-orbit.rollout.swe_agent.episode.generate}"
    ...
    --swe-agent-cmd-timeout-secs "${SWE_AGENT_CMD_TIMEOUT_SECS:-30}"
)
