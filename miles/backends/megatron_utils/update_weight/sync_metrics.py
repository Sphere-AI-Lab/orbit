...
to the file named by the ``MILES_TIMELINE_EVENTS_FILE`` env var; when it is
...
TIMELINE_EVENTS_ENV_VAR = "MILES_TIMELINE_EVENTS_FILE"
...
def emit_timeline_event(
    ...
    *,
    ...
    """Append one JSONL timeline marker to ``MILES_TIMELINE_EVENTS_FILE``.
