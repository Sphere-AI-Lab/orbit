...
_SKIPPED_SERVER_ARGS = [
    ...
    # manually-added --sglang-enforce-piecewise-cuda-graph override (added in add_sglang_arguments)
    # doesn't collide
...
def validate_args(args):
    ...
    # ORBIT-SEAM: applies the prefill-cuda-graph default/OFT guard above
    ...
    # ORBIT-SEAM: attn_cp/moe_dp derivation (upstream converged on dropping base's direct
    # sglang_dp_size/pp_size/ep_size assignments -- the prefixed-arg mirror produces them).
