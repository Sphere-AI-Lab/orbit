...
def _walk_megatron_modules(model_chunks) -> Iterable[dict[str, Any]]:
    ...
    for chunk_idx, chunk in enumerate(model_chunks):
        ...
        for module_name, module in named_modules():
            ...
            for adapter_attr in (
                "adapter",         # OFTLinear
                "adapter_q", "adapter_k", "adapter_v",   # OFTLinearSplitQKV
                "adapter_gate", "adapter_up",            # OFTLinearSplitFC1UpGate
            ):
            ...
            for adapter_attr in ("adapter", "adapter_q", "adapter_k", "adapter_v",
...
def dump_megatron_audit(model_chunks, *, base_path: str | None = None) -> int:
    ...
    if world is None:
        world = {"tp_rank": 0, "tp_size": 1, "pp_rank": 0, "dp_rank": 0,
                 "ep_rank": 0, "ep_size": 1}
    if world["dp_rank"] > 0:
