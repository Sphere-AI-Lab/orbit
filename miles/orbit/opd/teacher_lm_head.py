...
miles/rollout/generate_utils/generate_endpoint_utils.py), not its full vocab logits --
...
from miles.orbit.opd.vocab_parallel import vocab_shard_start
...
def load_teacher_lm_head(args: Namespace, local_vocab_size: int | None = None) -> torch.Tensor:
    ...
    miles/backends/megatron_utils/actor.py's sleep()/wake_up() hooks).
    """
