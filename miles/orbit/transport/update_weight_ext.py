...
from miles.orbit.megatron.sync_metrics import _sync_type_label
from miles.orbit.transport.slots import (
    MutationPurpose,
...
class OrbitUpdateWeightExtensions:
    ...
    def push_teacher_adapter(self) -> None:
        ...
        from miles.orbit.opd.opd_teacher_spec import OPD_TEACHER_ADAPTER_NAME
