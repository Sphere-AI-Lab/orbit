...
# ORBIT-SEAM (re-anchored from miles/ray/rollout.py, split into this package by upstream dbbab156):
# uses_rollout_engines gates rollout-engine bootstrap for configs that never use engines;
# should_run_periodic_action drives the rollout_global_dataset save-snapshot check in generate()
...
class RolloutManager:
    ...
    async def generate(self, rollout_id):
        ...
        # ORBIT-SEAM: OPD deferred full-vocab teacher scoring hook (scores after rollout, before
