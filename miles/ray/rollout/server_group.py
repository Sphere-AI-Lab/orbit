        ...
        for i in range(len(self.all_engines)):
            ...
            env_vars = build_noset_visible_devices_env_vars() | {
                ...
                for key, default_val in {
                    ...
                    # ORBIT-SEAM: batch-invariant-ops / DSV4 tile-kernel engine env var defaults (orbit
                    # determinism + DSV4 support); the FALLBACK_VARIANT default flips upstream's "true"
                    # off because orbit's determinism recipe routes MM through the DeepGEMM variant
