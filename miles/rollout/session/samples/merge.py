...
# ORBIT-SEAM: normalized policy-version extraction for the true-on-policy contract. Re-anchored
# here from miles/rollout/generate_utils/openai_endpoint_utils.py, which upstream dbbab156 emptied
# into this module (the seam's surrounding code moved, the seam did not change).
...
def _compute_sample_from_openai_record(
    ...
    # ORBIT-SEAM: normalized policy-version extraction (see _record_policy_version above)
