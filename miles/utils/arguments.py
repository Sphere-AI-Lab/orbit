...
def _common_orbit_validate_args(args):
    ...
    if args.colocate and uses_rollout_engines(args):
        ...
        if args.offload_rollout is None:
            args.offload_rollout = True
        # ORBIT-SEAM: getattr-tolerant piecewise-CUDA-graph handling (older sglang does not expose these ServerArgs), and an explicit --sglang-enforce-piecewise-cuda-graph now wins instead of being warned about and ignored
