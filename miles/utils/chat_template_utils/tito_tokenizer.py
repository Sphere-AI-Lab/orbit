...
# ORBIT-SEAM: orbit's added expected_ids_for_finish_reason hook lives in the home layer
# (orbit/utils/chat_template_utils/tito_ext.py); the two classes below list its mixins first.
