...
This directory contains shell helpers that belong to the envpack Miles plugin,
...
By default, repo discovery uses only `$MILES_REPO/thirdparty/envpack`. Set
...
against the envpack submodule/pointer recorded by IMP-Miles.
