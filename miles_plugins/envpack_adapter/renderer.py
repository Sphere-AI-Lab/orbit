"""Miles-side rendering helpers for envpack observations."""
...
def observation_to_chat_message(observation, *, role: str = "user") -> RenderedObservation:
    """Convert envpack SemanticObservation to Miles/VLM chat-message pieces.
...
def _decode_image(data: bytes):
    try:
        ...
        raise EnvpackRendererError("Pillow is required to decode envpack image bytes for Miles processors") from exc
