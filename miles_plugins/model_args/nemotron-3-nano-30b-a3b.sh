...
# The AutoBridge path (--megatron-to-hf-mode bridge) + orbit NemotronHBridge MoE shim
# (see miles_plugins/megatron_bridge/patches/bridges/nemotron_h.py) construct the
# provider and HF↔Megatron mapping_registry at load time. Attention-side structural
# args go in MODEL_ARGS for orbit's arg parser.
