...
from orbit.utils.multi_lora import is_multi_lora_enabled, targets_expert_leaves
...
def _setup_lora_model_via_bridge(args: Namespace) -> list:
    ...
    if is_multi_lora_enabled(args):
        ...
        from orbit.backends.megatron_utils.multi_lora_utils import create_multi_lora_instance
