...
``export_hf_model_direct`` goes through orbit' own megatron->HF converters (the
...
from orbit.backends.megatron_utils.lora_utils import is_lora_model, save_lora_checkpoint
from orbit.backends.megatron_utils.update_weight.common import named_params_and_buffers
...
from orbit.utils.hf_config import HF_EXPORT_COMPLETE_MARKER, load_hf_config
from orbit.utils.megatron_bridge_utils import patch_megatron_model
...
def export_hf_model_direct(
    ...
    *,
    ...
    """Export current weights as an HF checkpoint via orbit' own megatron->HF converters.
