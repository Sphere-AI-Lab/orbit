...
if TYPE_CHECKING:
    from orbit.utils.audit_utils.event_logger.models import OptimizerStateInfo, TrainEngineLocalWeightChecksumState
...
def _compute_weight_checksum_state(
    ...
    from orbit.utils.audit_utils.event_logger.models import TrainEngineLocalWeightChecksumState
...
def _collect_optimizer_hashes(
    ...
    from orbit.utils.audit_utils.event_logger.models import OptimizerStateInfo
