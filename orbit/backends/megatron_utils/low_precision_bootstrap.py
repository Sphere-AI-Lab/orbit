...
from orbit.utils.hf_config import load_hf_config as _load_hf_config
...
def _modelopt_state_already_restored(parallel_model, checkpoint_path) -> bool:
    ...
    return bool(parallel_model) and all(
        getattr(model, "_orbit_restored_modelopt_checkpoint_path", None) == expected_path for model in parallel_model
    )
