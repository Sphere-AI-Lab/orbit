...
from orbit.utils.disk_delta import NUM_WORKERS, checksum, make_tensor_reader, overwrite_encode
...
class UpdateWeightFromDiskDelta(DistBucketedWeightUpdateMixin):
    ...
    the patched local checkpoint via the ordinary update_weights_from_disk path. orbit only ever
    ...
    def connect_rollout_engines(
        ...
        self._group_name = "orbit-disk-delta"
