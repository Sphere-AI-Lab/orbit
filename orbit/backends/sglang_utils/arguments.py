...
from orbit.utils.http_utils import _wrap_ipv6
...
def validate_args(args):
    ...
    # --true-on-policy parse-time expansion (orbit/peft/true_on_policy/config.py),
    ...
    if args.sglang_router_policy:
        ...
        ), "--sglang-router-policy is not supported with ORBIT_EXPERIMENTAL_ROLLOUT_REFACTOR=1"
