...
_PROFILE_OPD_DAGGER = os.environ.get("ORBIT_PROFILE_OPD_DAGGER", "0") == "1"
...
def _maybe_dump_top_logprob_backward(name: str, tensor: torch.Tensor) -> None:
    ...
    try:
        ...
        dump_dir = os.environ.get("ORBIT_LOGPROB_BACKWARD_DEBUG_DIR")
    except Exception:
        dump_dir = None
    ...
    def hook(grad: torch.Tensor) -> torch.Tensor:
        ...
        print(f"[ORBIT_LOGPROB_BACKWARD_DEBUG] {stats} wrote {path}", flush=True)
        return grad
