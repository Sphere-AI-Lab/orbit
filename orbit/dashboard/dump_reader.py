...
from orbit.backends.training_utils.cp_utils import assemble_log_prob_from_cp, get_logits_and_tokens_offset_with_cp
...
class DumpReader:
    ...
    def _rollout_columns(self, rollout_id: int, sample_index: int, *, evaluation: bool) -> dict:
        ...
        if not path.exists() or set(pl.read_parquet_schema(path)) != set(self.ROLLOUT_COLUMNS):
            from orbit.ray.rollout.debug_data import save_dashboard_columns
