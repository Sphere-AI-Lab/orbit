"""HTTP API of the orbit dashboard.
...
from orbit.dashboard.advisory import DEFAULT_LOW_MFU, compute_advisories, mfu_summary
from orbit.dashboard.dump_reader import STEP_AGGREGATE_METRICS, DumpReader, DumpStillWriting
from orbit.dashboard.store import MetricStore, Stream
...
def make_app(
    ...
    *,
    ...
    app = FastAPI(title="orbit dashboard", docs_url=None, redoc_url=None)
