...
* ``update_weight...broadcast.update_weights_from_distributed`` -- weight-sync
  ...
  the dispatch above it. The ``selector`` parameter is newer than
  orbit-main-isolated's miles base and is forwarded untouched.
...
@patch_function(
    ...
    upstream_sha="91111a65dfa6099deaf06c99d3d26b8fa2fb7908742edd3ad0183c66765cd0ad",
