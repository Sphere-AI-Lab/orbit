...
# go here; new features land in orbit/ray/train/group.py (v2). Dispatch between
# v1 and v2 happens in orbit/ray/placement_group.py based on the env var
# ORBIT_EXPERIMENTAL_FT_TRAINER (default off -> v1).
