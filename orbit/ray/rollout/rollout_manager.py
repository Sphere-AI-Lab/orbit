...
from orbit.ray.rollout.metrics import log_eval_rollout_data, log_eval_skip, log_rollout_data
from orbit.ray.rollout.rollout_data_conversion import postprocess_rollout_data
from orbit.ray.rollout.rollout_server import RolloutServer, start_rollout_servers
from orbit.ray.rollout.router_manager import start_session_server
...
from orbit.ray.utils import Lock
...
from orbit.rollout.checkpoint_eval import CheckpointEvalFn, EvalSkip
...
from orbit.utils.audit_utils.event_analyzer import analyzer as event_analyzer
from orbit.utils.audit_utils.event_logger import checkpoint as event_logger_checkpoint
from orbit.utils.audit_utils.process_identity import RolloutManagerProcessIdentity
from orbit.utils.environ import use_legacy_rollout_v1
from orbit.utils.health_monitor import RolloutHealthMonitor
from orbit.utils.hf_config import is_complete_hf_export
    ...
    def dispose(self):
        ...
        try:
            ...
            if getattr(self.args, "use_opd", False):
                ...
                from orbit.rollout.on_policy_distillation import close_scoring_transport
