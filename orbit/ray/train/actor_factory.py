...
from orbit.ray.utils import NOSET_VISIBLE_DEVICES_ENV_VARS_LIST
from orbit.utils.environ import default_fp8_block_scaling_fp32_scales
from orbit.utils.ft_utils.heartbeat_utils import HeartbeatStatus
...
def allocate_gpus_for_actor(
    ...
    if backend == "megatron":
        ...
        from orbit.backends.fsdp_utils import FSDPTrainRayActor
