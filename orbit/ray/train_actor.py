...
import orbit.utils.eval_config
...
from orbit.utils.distributed_utils import init_gloo_group
...
from orbit.utils.test_utils.det_process_group import DET_NCCL_BACKEND_NAME, register_det_nccl_backend
from orbit.utils.test_utils.fault_injector import inject_fault as _inject_fault
...
class TrainRayActor(RayActor):
    ...
    def init(self, args, role, with_ref=False, with_opd_teacher=False):
        ...
        torch.serialization.add_safe_globals([orbit.utils.eval_config.EvalDatasetConfig])
