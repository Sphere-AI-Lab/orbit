...
graders::
    ...
    --custom-rm-path orbit.rewards.reward_router.reward_func
    --group-rm
...
from orbit.rewards.genrm_judge import reward_func as _genrm_reward
from orbit.rewards.llm_judge import reward_func as _judge_reward
from orbit.rewards.sandbox.code_rm import reward_func as _code_reward
from orbit.rewards.sandbox.swe_rm import reward_func as _swe_reward
    ...
    try:
        ...
        for sample in samples:
            ...
            if route == "judge":
                ...
                from orbit.rewards.ultra_agents import grade_tool_call

                rewards.append(grade_tool_call(sample.response, metadata.get("expected_action")))
            elif route == "mcqa":
                from orbit.rewards.ultra_agents import grade_mcqa
                ...
                from orbit.rewards.ultra_longtail import grade_boxed_answer

                rewards.append(grade_boxed_answer(sample.response, sample.label or metadata.get("expected_answer")))
            elif route == "nvarc_t":
                from orbit.rewards.ultra_longtail import grade_nvarc_transductive

                rewards.append(grade_nvarc_transductive(sample.response, metadata.get("expected_output")))
            elif route == "nvarc_i":
                from orbit.rewards.ultra_longtail import grade_nvarc_inductive
                ...
                from orbit.rewards.ultra_longtail import grade_verifier_spec

                rewards.append(grade_verifier_spec(sample.response, metadata.get("verifier")))
            elif route == "calendar":
                from orbit.rewards.ultra_longtail import grade_calendar

                rewards.append(grade_calendar(sample.response, metadata.get("exp_cal_state")))
            elif route == "lean":
                from orbit.rewards.lean_rm import grade_lean_proof
                ...
                from orbit.rewards.ultra_longtail import grade_rubric_judge
                ...
                from orbit.rewards.ultra_longtail import grade_policy_judge
                ...
                from orbit.rewards.ultra_agents import grade_instruction_following
