...
Wire-up (dedicated swe runs)::
    ...
    --custom-generate-function-path orbit.rewards.swe_agent.episode.generate
...
from orbit.rewards.swe_agent.container_session import ContainerSession, sif_for_instance
