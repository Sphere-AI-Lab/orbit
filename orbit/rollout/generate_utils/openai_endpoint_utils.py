...
from orbit.rollout.generate_utils.generate_endpoint_utils import get_rollout_topk_from_response
from orbit.rollout.session.session_types import GetSessionResponse, SessionRecord
...
def _record_policy_version(sample, meta_info: dict) -> None:
    from orbit.utils.types import _extract_policy_version
