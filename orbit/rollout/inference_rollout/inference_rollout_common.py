...
from orbit.rollout.generate_hub.single_turn import generate
from orbit.rollout.generate_utils.generate_endpoint_utils import policy_uses_routing_key
from orbit.rollout.group_utils import group_has_aborted_sample
...
class InferenceRolloutFn:
    ...
    async def _call_train(self, input: RolloutFnTrainInput) -> RolloutFnTrainOutput:
        from orbit.rollout.inference_rollout.inference_rollout_train import generate_rollout_async
