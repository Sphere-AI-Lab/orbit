...
from orbit.rollout.data_source import DataSource, RolloutDataSource
from orbit.utils.adapter_config import AdapterRun
from orbit.utils.types import AdapterRef, RewardSpec, Sample
...
class MultiLoRAAsyncDataSource(DataSource):
    ...
    def close(self) -> None:
        from orbit.rollout.multi_lora.async_rollout import AsyncMultiLoRAWorker
