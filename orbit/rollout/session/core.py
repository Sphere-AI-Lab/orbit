...
from orbit.rollout.session.errors import (
...
from orbit.rollout.session.samples.codec import encode_samples
from orbit.rollout.session.samples.merge import (
...
def prepare_chat_request(body: bytes, args, tito_tokenizer) -> tuple:
    ...
    # TITO token tracking needs Orbit-owned input_ids plus SGLang output
