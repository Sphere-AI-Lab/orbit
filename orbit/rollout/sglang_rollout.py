...
from orbit.rollout.base_types import GenerateFnInput, RolloutFnEvalOutput, RolloutFnTrainOutput
...
from orbit.utils.misc import SingletonMeta, call_agent_abort_hook, load_function
from orbit.utils.multi_lora import make_rid, slot_lora_name
...
async def generate(args: Namespace, sample: Sample, sampling_params: dict[str, Any]) -> Sample:
    ...
    if sample.adapter is not None:
        from orbit.ray.multi_lora.controller import AdaptersCache
