# Vendored from sglang 0.5.14.dev37+gf8cfad3 srt/entrypoints/openai/encoding_dsv32.py so orbit can modify the render behavior locally.
...
def render_message(
    ...
    if role == "system":
        ...
        # Orbit modification: with drop_thinking=False every turn keeps its
        ...
        # Orbit modification: TiTO disallows drop_thinking=True.
        ...
        # Orbit modification: drop_thinking=False keeps every assistant's
