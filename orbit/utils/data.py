...
from orbit.ray.rollout.train_data_conversion import split_train_data_by_dp_raw
...
from orbit.utils import chat_template_utils
from orbit.utils.processing_utils import call_processor
from orbit.utils.types import MultimodalTypes, Sample
    ...
    if processor:
        ...
        if multimodal:
            for sample in multimodal:
                # sample.prompt is the templated string by now, which qwen's
                # extract_vision_info cannot parse (it indexes messages as dicts);
                # this branch only holds samples whose vision inputs were already
                # extracted at Sample build time — reuse them, never re-extract.
    ...
    def __init__(
        ...
        *,
        ...
        for data in read_file(path):
            ...
            if processor:
                from orbit.utils.processing_utils import process_vision_info
...
def process_rollout_data(
    ...
    from orbit.ray.rollout.train_data_conversion import process_rollout_data_shard
