...
def _sample_has_multimodal_inputs(sample: Sample) -> bool:
    multimodal_inputs = sample.multimodal_inputs or {}
    return any(_has_multimodal_value(multimodal_inputs.get(key)) for key in ("images", "videos", "audios", "audio"))
    ...
    if multimodal_keys:
        ...
        for message in prompt:
            if isinstance(message["content"], str):
                ...
                # Follow-up: handle more general cases. where message['content'] is a dict and contains multiple types of content.
                # e.g.
                #  "content": [
                #     {
                #         "type": "image",
