...
from orbit.utils.data import read_file
...
def main(
    ...
    """
    Minimally send prompts to SGLang using OpenAI endpoints with arguments in the same format as main Orbit.

    Example usage:
    python -m orbit.utils.debug_utils.send_to_sglang --prompt-data /root/datasets/aime-2024/aime-2024.jsonl --input-key prompt --n-samples-per-prompt 16 --rollout-max-response-len 32768 --rollout-temperature 1 --rollout-top-p 1
    """
