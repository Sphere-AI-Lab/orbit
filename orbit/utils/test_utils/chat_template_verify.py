...
from orbit.utils.chat_template_utils import TITOTokenizerType
from orbit.utils.chat_template_utils.template import apply_chat_template_from_str
from orbit.utils.chat_template_utils.tito_tokenizer import ALL_APPEND_ROLES
...
from orbit.utils.test_utils.mock_trajectories import (  # noqa: E402
...
def verify_append_only_via_tito(
    ...
    **template_kwargs,
    ...
    Matches the production wiring at ``orbit/rollout/session/sessions.py:35`` —
