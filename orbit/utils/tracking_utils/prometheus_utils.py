...
_METRIC_PREFIX = "orbit_metric_"
_COLLECTOR_ACTOR_NAME = "orbit_prometheus_collector"
...
class _PrometheusCollector:
    ...
    def __init__(self, args):
        ...
        self._gauges: dict = {}
        self._run_name = (
            getattr(args, "prometheus_run_name", None) or getattr(args, "wandb_group", None) or "orbit_training"
        )
