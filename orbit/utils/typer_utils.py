...
def dataclass_cli(func, env_var_prefix: str = "ORBIT_SCRIPT_"):
...
if __name__ == "__main__":
    ...
    res1 = runner.invoke(app, [], env={"ORBIT_SCRIPT_NAME": "EnvName", "ORBIT_SCRIPT_COUNT": "10"})
    print(f"{res1.stdout=}")
    assert res1.exit_code == 0
    assert "EnvName|10" in res1.stdout.strip()

    res2 = runner.invoke(app, ["--count", "999"], env={"ORBIT_SCRIPT_NAME": "EnvName"})
    print(f"{res2.stdout=}")
