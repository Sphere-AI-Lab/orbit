...
from orbit_plugins.models.deepseek_v4.ops.compressor import DeepSeekV4Compressor
from orbit_plugins.models.deepseek_v4.ops.cp_utils import (
    all_gather_cp,
...
from orbit_plugins.models.deepseek_v4.ops.kernel.tilelang_sparse_mla import sparse_attn_tilelang
from orbit_plugins.models.deepseek_v4.ops.qat import fp8_simulate_qat
from orbit_plugins.models.deepseek_v4.ops.rope import apply_rotary_emb, wrapped_precompute_freqs_cis
from orbit_plugins.models.deepseek_v4.ops.v4_indexer import V4Indexer
    ...
    def __init__(
        ...
        if self.compress_ratio:
            ...
            if self.compress_ratio == 4:
                ...
                topk_backend = config.orbit_dsa_topk_backend
                if indexer_impl == "tilelang":
                    self.indexer = V4Indexer(config=config, pg_collection=pg_collection)
                else:
                    if topk_backend != "torch":
                        raise ValueError(
                            "DeepSeek V4 orbit DSA topk backend is only supported with V4_INDEXER_IMPL=tilelang; "
...
def get_dsv4_spec(args, config, vp_stage):
    """
    Usage: --spec orbit_plugins.models.deepseek_v4.deepseek_v4 get_dsv4_spec
    """
    config.orbit_dsa_topk_backend = args.orbit_dsa_topk_backend
