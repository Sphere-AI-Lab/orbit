...
from orbit_plugins.models.deepseek_v4.ops.cp_utils import all_gather_cp, get_freqs_cis_for_cp
from orbit_plugins.models.deepseek_v4.ops.kernel.tilelang_indexer_fwd import (
...
from orbit_plugins.models.deepseek_v4.ops.utils import rotate_activation
from orbit_plugins.models.dsa_topk import get_dsa_topk_fn
...
class V4Indexer(MegatronModule):
    ...
    def __init__(self, config: TransformerConfig, pg_collection=None):
        ...
        self.topk_backend = config.orbit_dsa_topk_backend
