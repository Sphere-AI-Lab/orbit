...
from orbit_plugins.models.inkling.ops import (
    cp_all_gather,
    cp_world,
)
from orbit_plugins.models.inkling.ops import create_block_mask as _create_block_mask
from orbit_plugins.models.inkling.ops import flex_compiled as _flex
from orbit_plugins.models.inkling.ops import (
...
class InklingSelfAttention(SelfAttention):
    ...
    def _attend(self, q, k, v, r, seqlens):
        if self.attn_backend == "fa4":
            from orbit_plugins.models.inkling.ops import inkling_fa4_attention as _fa4
