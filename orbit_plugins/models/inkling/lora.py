...
def apply_inkling_lora(model, args):
    ...
    from orbit.backends.megatron_utils.lora_utils import patch_param_grad_buffer_for_colocate_mode_lora

    from orbit_plugins.models.inkling.layers import InklingDenseMLP, InklingSelfAttention, InklingSharedExperts
...
def wrap_model_provider_with_inkling_lora(provider_func, args):
    """Wrap a orbit model provider so every built chunk gets LoRA before DDP wrap."""
