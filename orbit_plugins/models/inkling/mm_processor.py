...
from orbit_plugins.models.inkling.image_processing import InklingImagePatchifier
...
class InklingTrainProcessor:
    """Duck-typed processor for orbit' generic multimodal pipeline (Inkling)."""
    ...
    def __init__(self, hf_checkpoint: str):
        ...
        from orbit_plugins.models.inkling.audio_processing import InklingAudioDmelExtractor
