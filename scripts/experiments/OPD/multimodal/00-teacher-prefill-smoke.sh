...
#
# The 30B-A3B teacher is owner-managed because submit.sh only downloads the
# student processor and Geo3K data automatically:
#   hf download Qwen/Qwen3-VL-30B-A3B-Thinking \
#     --local-dir /data/shared/models/Qwen3-VL-30B-A3B-Thinking
