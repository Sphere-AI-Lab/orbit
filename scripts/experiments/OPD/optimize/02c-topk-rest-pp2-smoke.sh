#!/bin/bash
# Milestone 02c: 5-step pipeline-last-stage ownership smoke (TP=2, PP=2, DP=2).
...
export TRAIN_PP_SIZE=2
export WANDB_RUN_NAME=${WANDB_RUN_NAME:-02c-top${OPD_DAGGER_TOP_K}-rest-c${OPD_DAGGER_COEF}-pp2-smoke}
