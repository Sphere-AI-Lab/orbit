#!/bin/bash
#
# Envpack FrozenLake-main GRPO on Qwen3-VL-2B-Instruct, 1 node x 8 GPUs
...
# Qwen3-VL <think> -> <thinking> swap; envpack prompts intentionally keep the
# same env var as the VAGEN donor for parser/prompt parity.
export VAGEN_THINK_TAG=thinking
...
_BUILD_HINT="Build it with: scripts/experiments/server_train/build-envpack-main.sh frozenlake"
