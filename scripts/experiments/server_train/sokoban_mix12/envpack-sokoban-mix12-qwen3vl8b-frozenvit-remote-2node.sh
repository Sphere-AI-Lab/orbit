#!/bin/bash
#
# Qwen3-VL-8B Sokoban mix12, 2 nodes, ViT FROZEN.
#
# mix12 = concatenated 6x6 1box + 6x6 2box balanced datasets.
#
# Submit:
#   JOB_NAME=rv2-8b-vitoff-mix12 WANDB_RUN_PREFIX= TIME=72:00:00 \
#   WANDB_INIT_TIMEOUT=300 NODES=2 ENVPACK_SERVER_NODE_COUNT=1 MILES_ENV_NAME=miles_imp \
#   bash scripts/slurm/submit.sh \
#     server_train/sokoban_mix12/envpack-sokoban-mix12-qwen3vl8b-frozenvit-remote-2node
