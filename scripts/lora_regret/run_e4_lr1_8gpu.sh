#!/usr/bin/env bash
#
# E4, learning-rate column 1 of 7: FullFT at 5e-07 and LoRA r1/r16/r256 at 5e-06.
# Book a WHOLE node.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-lr5e\-07|lora-r(1|16|256)-all-lr5e\-06)-s' RESULTS=results/e4_lr1.jsonl EXPECT_ARMS=4 \
