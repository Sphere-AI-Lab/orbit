#!/usr/bin/env bash
#
# E4, learning-rate column 1 of 7, BOTH panels: FullFT at 5e-07 and LoRA
# r1/r16/r256 at 5e-06, on gsm8k and on math.  Book a WHOLE node.
#
#   bash scripts/lora_regret/run_e4_lr1_8gpu.sh
#
...
# section 23.4), so column 1 pairs the 1th point of each: 5e-07 against 5e-06.
#
...
# measured at eight.
exec env MATRIX=e4 METHOD_RE='^(full-na-na-(gsm8k|math)-lr5e\-07|lora-r(1|16|256)-all-(gsm8k|math)-lr5e\-06)-s' RESULTS=results/e4_lr1.jsonl EXPECT_ARMS=8 \
