#!/usr/bin/env bash
#
# E4, learning-rate column 2 of 7, BOTH panels: FullFT at 1e-06 and LoRA
# r1/r16/r256 at 1e-05, on gsm8k and on math.  Book a WHOLE node.
#
...
# measured at eight.
exec env MATRIX=e4 METHOD_RE='^(full-na-na-(gsm8k|math)-lr1e\-06|lora-r(1|16|256)-all-(gsm8k|math)-lr1e\-05)-s' RESULTS=results/e4_lr2.jsonl EXPECT_ARMS=8 \
