#!/usr/bin/env bash
#
# E4, learning-rate column 3 of 7, BOTH panels: FullFT at 3e-06 and LoRA
# r1/r16/r256 at 3e-05, on gsm8k and on math.  Book a WHOLE node.
#
#   bash scripts/lora_regret/run_e4_lr3_8gpu.sh
#
...
# measured at eight.
exec env MATRIX=e4 METHOD_RE='^(full-na-na-(gsm8k|math)-lr3e\-06|lora-r(1|16|256)-all-(gsm8k|math)-lr3e\-05)-s' RESULTS=results/e4_lr3.jsonl EXPECT_ARMS=8 \
