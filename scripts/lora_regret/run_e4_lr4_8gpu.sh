#!/usr/bin/env bash
#
# E4, learning-rate column 4 of 7: FullFT at 7e-06 and LoRA r1/r16/r256 at 7e-05.
# Book a WHOLE node.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-lr7e\-06|lora-r(1|16|256)-all-lr7e\-05)-s' RESULTS=results/e4_lr4.jsonl EXPECT_ARMS=4 \
