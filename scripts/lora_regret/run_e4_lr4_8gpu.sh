#!/usr/bin/env bash
#
# E4, learning-rate column 4 of 7, BOTH panels: FullFT at 7e-06 and LoRA
# r1/r16/r256 at 7e-05, on gsm8k and on math.  Book a WHOLE node.
#
#   bash scripts/lora_regret/run_e4_lr4_8gpu.sh
#
...
# section 23.4), so column 4 pairs the 4th point of each: 7e-06 against 7e-05.
#
...
# measured at eight.
exec env MATRIX=e4 METHOD_RE='^(full-na-na-(gsm8k|math)-lr7e\-06|lora-r(1|16|256)-all-(gsm8k|math)-lr7e\-05)-s' RESULTS=results/e4_lr4.jsonl EXPECT_ARMS=8 \
