#!/usr/bin/env bash
#
# E4, learning-rate column 5 of 7, BOTH panels: FullFT at 2e-05 and LoRA
# r1/r16/r256 at 0.0002, on gsm8k and on math.  Book a WHOLE node.
#
#   bash scripts/lora_regret/run_e4_lr5_8gpu.sh
#
...
# measured at eight.
exec env MATRIX=e4 METHOD_RE='^(full-na-na-(gsm8k|math)-lr2e\-05|lora-r(1|16|256)-all-(gsm8k|math)-lr0\.0002)-s' RESULTS=results/e4_lr5.jsonl EXPECT_ARMS=8 \
