#!/usr/bin/env bash
#
# E4, learning-rate column 6 of 7: FullFT at 4e-05 and LoRA r1/r16/r256 at 0.0004.
# Book a WHOLE node.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-lr4e\-05|lora-r(1|16|256)-all-lr0\.0004)-s' RESULTS=results/e4_lr6.jsonl EXPECT_ARMS=4 \
