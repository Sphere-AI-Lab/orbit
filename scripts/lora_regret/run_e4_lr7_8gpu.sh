#!/usr/bin/env bash
#
# E4, learning-rate column 7 of 7: FullFT at 0.0001 and LoRA r1/r16/r256 at 0.001.
# Book a WHOLE node.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-lr0\.0001|lora-r(1|16|256)-all-lr0\.001)-s' RESULTS=results/e4_lr7.jsonl EXPECT_ARMS=4 \
