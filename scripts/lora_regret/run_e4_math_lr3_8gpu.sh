#!/usr/bin/env bash
#
# E4, math panel, learning-rate column 3 of 7: FullFT at 3e-06 and LoRA
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-math-lr3e\-06|lora-r(1|16|256)-all-math-lr3e\-05)-s' RESULTS=results/e4_math_lr3.jsonl EXPECT_ARMS=4 \
