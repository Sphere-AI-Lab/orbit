#!/usr/bin/env bash
#
# E4, math panel, learning-rate column 3 of 7: FullFT at 3e-07 and LoRA
...
#   bash scripts/lora_regret/run_e4_math_lr3_8gpu.sh
#
...
# section 23.4), so column 3 pairs the 3th point of each: 3e-07 against 3e-05.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-math-lr3e\-07|lora-r(1|16|256)-all-math-lr3e\-05)-s' RESULTS=results/e4_math_lr3.jsonl EXPECT_ARMS=4 \
