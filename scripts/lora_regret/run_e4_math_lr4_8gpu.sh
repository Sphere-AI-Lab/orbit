#!/usr/bin/env bash
#
# E4, math panel, learning-rate column 4 of 7: FullFT at 7e-07 and LoRA
...
# section 23.4), so column 4 pairs the 4th point of each: 7e-07 against 7e-05.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-math-lr7e\-07|lora-r(1|16|256)-all-math-lr7e\-05)-s' RESULTS=results/e4_math_lr4.jsonl EXPECT_ARMS=4 \
