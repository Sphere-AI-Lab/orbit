#!/usr/bin/env bash
#
# E4, math panel, learning-rate column 4 of 7: FullFT at 7e-06 and LoRA
# r1/r16/r256 at 7e-05.  Book a WHOLE node.
#
#   source /fast/zqiu/orbit-iclr/orbit_env/bin/activate
#   cd /lustre/fast/fast/zqiu/orbit-iclr/orbit
#   bash scripts/lora_regret/run_e4_math_lr4_8gpu.sh
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-math-lr7e\-06|lora-r(1|16|256)-all-math-lr7e\-05)-s' RESULTS=results/e4_math_lr4.jsonl EXPECT_ARMS=4 \
