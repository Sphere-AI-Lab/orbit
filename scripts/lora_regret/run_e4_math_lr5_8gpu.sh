#!/usr/bin/env bash
#
# E4, math panel, learning-rate column 5 of 7: FullFT at 2e-06 and LoRA
...
# section 23.4), so column 5 pairs the 5th point of each: 2e-06 against 0.0002.
#
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-math-lr2e\-06|lora-r(1|16|256)-all-math-lr0\.0002)-s' RESULTS=results/e4_math_lr5.jsonl EXPECT_ARMS=4 \
