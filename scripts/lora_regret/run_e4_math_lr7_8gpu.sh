#!/usr/bin/env bash
#
# E4, math panel, learning-rate column 7 of 7: FullFT at 1e-05 and LoRA
...
exec env MATRIX=e4 METHOD_RE='^(full-na-na-math-lr1e\-05|lora-r(1|16|256)-all-math-lr0\.001)-s' RESULTS=results/e4_math_lr7.jsonl EXPECT_ARMS=4 \
