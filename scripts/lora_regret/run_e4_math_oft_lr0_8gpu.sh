#!/usr/bin/env bash
#
# E4 OFT, math panel, learning-rate column 0 of 6:
# b8/b128/b1024 at 2e-06. Book a WHOLE 8-GPU node.
#
#   source /fast/zqiu/orbit-iclr/orbit_env/bin/activate
#   cd /lustre/fast/fast/zqiu/orbit-iclr/orbit
#   bash scripts/lora_regret/run_e4_math_oft_lr0_8gpu.sh
#
...
exec env MATRIX=e4 METHOD_RE='^oftscout-b(8|128|1024)-all-math-lr2e\-06-s' RESULTS=results/e4_math_oft_lr0.jsonl EXPECT_ARMS=3 ALLOW_OFT=1 \
