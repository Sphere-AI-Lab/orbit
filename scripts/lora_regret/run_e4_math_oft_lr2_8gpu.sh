#!/usr/bin/env bash
#
# E4 OFT, math panel, learning-rate column 2 of 6:
...
#   bash scripts/lora_regret/run_e4_math_oft_lr2_8gpu.sh
#
...
exec env MATRIX=e4 METHOD_RE='^oftscout-b(8|128|1024)-all-math-lr1e\-05-s' RESULTS=results/e4_math_oft_lr2.jsonl EXPECT_ARMS=3 ALLOW_OFT=1 \
