#!/usr/bin/env bash
#
# E4 OFT, math panel, learning-rate column 3 of 6:
...
exec env MATRIX=e4 METHOD_RE='^oftscout-b(8|128|1024)-all-math-lr3e\-05-s' RESULTS=results/e4_math_oft_lr3.jsonl EXPECT_ARMS=3 ALLOW_OFT=1 \
