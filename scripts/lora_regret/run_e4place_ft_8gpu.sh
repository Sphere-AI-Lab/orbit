...
#
# 4 arms, ~5 h. **Drop this one first under budget pressure.** These arms answer
...
exec env MATRIX=e4place METHOD_RE='^full-' RESULTS=results/e4place_full.jsonl EXPECT_ARMS=4 \
