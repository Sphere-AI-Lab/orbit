...
MODEL_ARGS=($(MODEL_ARGS_ROTARY_BASE="${MODEL_ARGS_ROTARY_BASE:-}" python3 -c "from orbit.utils.external_utils.model_args_utils import load_model_args; print(load_model_args('qwen3-1.7B'))"))
