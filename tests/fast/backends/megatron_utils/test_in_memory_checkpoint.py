...
from orbit.backends.megatron_utils.ft.in_memory_checkpoint import InMemoryCheckpointManager


@pytest.fixture()
def manager():
    with patch("orbit.backends.megatron_utils.ft.in_memory_checkpoint.get_args") as mock_get_args:
