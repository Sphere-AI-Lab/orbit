...
def load_bridge_module():
    ...
    module_path = Path(__file__).resolve().parents[4] / "orbit_plugins" / "mbridge" / "qwen3_5.py"
...
def load_raw_export_module():
    module_path = (
        Path(__file__).resolve().parents[4] / "orbit" / "backends" / "megatron_utils" / "megatron_to_hf" / "qwen3_5.py"
    )
