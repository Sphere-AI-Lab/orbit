...
def test_post_layernorm_flags_propagate_to_megatron(monkeypatch):
    ...
    import orbit.backends.megatron_utils.arguments as megatron_arguments
    import orbit.utils.arguments as orbit_arguments

    monkeypatch.setattr(orbit_arguments, "orbit_validate_args", lambda args: None)
    ...
    args = orbit_arguments.parse_args()
