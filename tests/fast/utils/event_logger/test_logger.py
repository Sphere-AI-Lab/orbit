...
import orbit.utils.audit_utils.event_logger.logger as event_logger_module
from orbit.utils.audit_utils.event_logger.logger import (
    EventLogger,
    event_logger_context,
    get_event_logger,
    set_event_logger,
)
from orbit.utils.audit_utils.event_logger.models import MetricEvent, WitnessAllocateIdEvent
from orbit.utils.audit_utils.process_identity import MainProcessIdentity, TrainProcessIdentity
...
class TestReadEvents:
    def test_malformed_line_skipped_with_warning(self, tmp_path: Path) -> None:
        from orbit.utils.audit_utils.event_logger.logger import read_events
