...
from orbit.utils.ft_utils.health_checker import NoopHealthChecker, SimpleHealthChecker
from orbit.utils.test_utils.clock import FakeClock
...
class TestRolloutHealthCheckerPreservesImmediateFailure:
    def test_rollout_checker_forces_failure_threshold_one(self):
        ...
        from orbit.utils.ft_utils.health_checker import SimpleHealthCheckerConfig, create_rollout_cell_health_checker
