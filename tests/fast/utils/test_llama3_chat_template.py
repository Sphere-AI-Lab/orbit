...
from orbit.utils.chat_template_utils.autofix import TEMPLATE_DIR
...
BUNDLED_LLAMA3_JINJA = TEMPLATE_DIR / "llama3.1_pinned.jinja"
...
def test_pinned_template_matches_source():
    ...
    assert (
        ...
        "by running: orbit/utils/llama3_chat_template.py (extract and embed with raw string r\"\"\"...\"\"\")."
    )
...
def test_bundled_jinja_matches_the_pinned_python_constant():
    ...
    `orbit/utils/chat_template_utils/templates/llama3.1_pinned.jinja` (the file a
