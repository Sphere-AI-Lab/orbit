...
def _install_stub_peft_utils(monkeypatch):
    ...
    stub = ModuleType("miles.orbit.megatron.peft_utils")
    ...
    monkeypatch.setitem(sys.modules, "miles.orbit.megatron.peft_utils", stub)
...
def test_lora_a_init_method_reaches_bridge_as_capital_a_kwarg(monkeypatch):
    ...
    assert "lora_A_init_method" in _RecordingLoRA.last_kwargs, (
