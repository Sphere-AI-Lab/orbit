...
class TestE4Place:
    ...
    def test_the_mlp_rank_is_e3s_solved_match_not_a_round_number(self):
        ...
        from miles.orbit.utils.peft_param_match import matched_mlp_rank
...
class TestE4OftCapacityLadder:
    ...
    def test_the_capacity_reports_remain_visible_and_stable(self):
        ...
        from miles.orbit.utils.peft_param_match import megatron_module_shapes, oft_lora_match_report
