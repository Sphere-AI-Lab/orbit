...
from orbit.utils.ft_utils.process_group_utils import (
    GroupInfo,
    GroupsInfo,
    MultiPGUtil,
    _check_wait,
...
class TestRawPGUtilUnit:
    ...
    @patch("orbit.utils.ft_utils.process_group_utils.dist.AllreduceOptions", MagicMock)
    ...
    @patch("orbit.utils.ft_utils.process_group_utils.dist.BroadcastOptions", MagicMock)
