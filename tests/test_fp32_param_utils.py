"""Tests for the A_log fp32 preservation chain (port of miles 85fe6519a #975).
...
from miles.orbit.megatron.fp32_param_utils import (
...
class TestALogLoadPathEndToEnd:
    ...
    model. No distributed or real safetensor IO — only the two cast points we
    care about.
