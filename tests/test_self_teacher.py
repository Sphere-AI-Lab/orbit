...
from orbit.peft.utils.adapter_tensors import adapter_tensor_key_digest
from orbit.peft.opd.self_teacher import (
...
# Sidecar tests: extracted module lives at orbit.peft.opd.self_teacher_checkpoint
