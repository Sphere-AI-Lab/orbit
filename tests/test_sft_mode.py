...
sys.modules.setdefault("miles.backends.sglang_utils.arguments", sglang_args_module)

chat_template_package = types.ModuleType("miles.utils.chat_template_utils")
tito_tokenizer_module = types.ModuleType("miles.utils.chat_template_utils.tito_tokenizer")
...
sys.modules.setdefault("miles.utils.chat_template_utils", chat_template_package)
sys.modules.setdefault("miles.utils.chat_template_utils.tito_tokenizer", tito_tokenizer_module)

misc_module = types.ModuleType("miles.utils.misc")
misc_module.load_function = lambda path: None
sys.modules.setdefault("miles.utils.misc", misc_module)

from miles.utils.arguments import (  # noqa: E402
...
def test_sft_mode_applies_sft_defaults_and_disables_plain_rollout_engines(monkeypatch):
    monkeypatch.setattr("miles.utils.arguments._common_orbit_validate_args", lambda args: None)
