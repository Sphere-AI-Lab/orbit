...
CASES = [
    ...
    Case(
        ...
        precision="int4",
        peft="oft",
        script="examples/low_precision/run-qwen3-4b-int4-math-oft.sh",
        gpu_total=4,
        train_gpus_async=2,
        rollout_gpus_async=2,
        target_modules="linear_qkv,linear_proj,linear_fc1,linear_fc2",
    ...
    Case(
        ...
        precision="bf16",
        peft="oft",
        script="examples/high_precision/run-qwen3-30b-a3b-bf16-math-oft.sh",
        gpu_total=8,
        train_gpus_async=4,
    ...
    Case(
        ...
        precision="bf16",
        peft="lora",
        script="examples/high_precision/run-qwen3-30b-a3b-bf16-math-lora.sh",
        gpu_total=8,
        train_gpus_async=4,
        rollout_gpus_async=4,
        target_modules="linear_qkv,linear_proj,linear_fc1,linear_fc2",
