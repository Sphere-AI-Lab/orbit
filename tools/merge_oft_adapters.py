...
from miles.orbit.merge import get_strategy  # light: pulls only torch
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.save_megatron:
        from miles.orbit.merge.megatron_io import merge_megatron_adapters, write_megatron_adapter
